...
- [primefaces/primeng](https://github.com/primefaces/primeng) ([15.4.1](https://github.com/primefaces/primeng/releases/tag/15.4.1), 5 days ago) - The Most Complete Angular UI Component Library
...
- [jomjol/AI-on-the-edge-device](https://github.com/jomjol/AI-on-the-edge-device) - Easy to use device for connecting &#34;old&#34; measuring units (water, power, gas, ...) to the digital world (4 weeks ago)
...
- [SoftFever/OrcaSlicer](https://github.com/SoftFever/OrcaSlicer) - G-code generator for 3D printers (Bambu, Prusa, Voron, VzBot, RatRig, Creality, Flsun, etc.) (1 month ago)
- [greghesp/ha-bambulab](https://github.com/greghesp/ha-bambulab) - A Home Assistant Integration for Bambu Lab Printers (1 month ago)
